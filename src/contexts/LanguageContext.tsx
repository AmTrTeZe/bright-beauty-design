...
const translations: Record<Language, any> = {
  fr: {
    ...
    who: {
      ...
      exp5_detail: "Les Impériales - Casablanca Conference, African Cristal Festival,\nWorld Tourism Day - International Day of Happiness",
      ...
      tagline: "TRADEMARK™ | AS COLLECTIVE INTELLIGENCE",
    },
    where: {
      form: {
        nom: "NOM",
  ...
  en: {
    ...
    how: {
      ...
      sectionTitle: "INTEGRATION OF EXPERTISE & HYBRIDIZATION OF SKILLS",
      ...
      point3: "Top Management involved from end to end of the mission, to guarantee fluidity as well as added value,",
